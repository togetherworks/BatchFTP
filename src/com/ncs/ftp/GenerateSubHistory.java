...
public class GenerateSubHistory {
	 ...
	 */
	private static void generateSubHistory(String username, String password, String dbURL, String outputFile)
			throws IOException, SQLException, ClassNotFoundException {

		getConnection(username, password,dbURL);

		String strSQL =	"select * from VW_EXP_SUBC_HISTORY  " ;
	...
	public static void main(String[] args) throws IOException {
		try {
	 	  	generateSubHistory(args[0],args[1],args[2],args[3]);
	   		...
	   		System.out.println("System failed (Generating Subcase History) at record objid = "+ num + " IN TBALE "  + s);
